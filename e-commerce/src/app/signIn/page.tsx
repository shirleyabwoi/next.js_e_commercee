        ...
        <div className="w-full max-w-md">
          <div className="space-y-8">
            <div className="text-center lg:text-left">
              <h1 className="text-4xl font-medium text-black mb-2">Log in to Exclusive</h1>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
             <div className="space-y-6">
                ...
                <button type="submit" className="w-full h-12 bg-red-500 hover:bg-red-600 text-white text-base font-medium rounded-sm">Create Account</button>
                <button type="button" onClick={handleGoogleSignUp}className="w-full h-12 border-gray-300 text-white text-base font-medium rounded-sm hover:bg-gray-50 flex items-center justify-center gap-3" >
                    <svg className="w-5 h-5" viewBox="0 0 24 24">
                         ...
                         <path fill="#e0af19ff" d="M5.84 14.09c-.22-.66-.35-1.36-.35-2.09s.13-1.43.35-2.09V7.07H2.18C1.43 8.55 1 10.22 1 12s.43 3.45 1.18 4.93l2.85-2.22.81-.62z"/>
                         <path fill="#bd2517ff" d="M12 5.38c1.62 0 3.06.56 4.21 1.64l3.15-3.15C17.45 2.09 14.97 1 12 1 7.7 1 3.99 3.47 2.18 7.07l3.66 2.84c.87-2.6 3.3-4.53 6.16-4.53z"/>
                ...
                <div className="text-center">
                  ...
                  <Link href="/login" className="text-black font-medium underline hover:no-underline">Log in</Link>
                </div>
                </div>
                </div>
                </div>
